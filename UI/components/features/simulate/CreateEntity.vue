<template>
    <div style="height: 100%; width: 100%;">
        <h3>Simulation route "Create Entity"</h3>
        <div class="hb"></div>
        <div class="d-flex justify-content-center align-items-start rounded"
            ...
            <div style="width: 100%; padding: 1%;" class="d-flex justify-content-start align-items-start">
                <div class="d-flex flex-column justify-content-start align-items-start">
                    ...
                    <input type="text" placeholder="Action" disabled value="CreateEntity" name="Action">
                ...
                <div class="mx-3 d-flex flex-column justify-content-start align-items-start">
                    <label for="Prompt">Prompt</label>
                    <textarea name="Prompt" rows="7" cols="33" placeholder="Prompt" v-model="Prompt"></textarea>
                </div>
            </div>
...
<script setup>
    ...
    import { CreateEntity } from '~/services/npcforge'
    ...
    const RunHttp = async () => {
        try {
            ...
            res.value = await CreateEntity(name.value, Checksum.value, Prompt.value, AuthorizationToken.value)
        } catch (e) {
            console.error(e)
        } finally {
