<template>
    <div style="height: 100%; width: 100%;">
        <h3>Simulation route "Make Decision"</h3>
        <div class="hb"></div>
        <div class="d-flex justify-content-center align-items-start rounded"
            ...
            <div style="width: 100%; padding: 1%;" class="d-flex justify-content-start align-items-start">
                <div class="d-flex flex-column justify-content-start align-items-start">
                    ...
                    <input type="text" placeholder="Action" disabled value="MakeDecision" name="Action">
                ...
                <div class="mx-3 d-flex flex-column justify-content-start align-items-start">
                    ...
                    <textarea name="Message" rows="7" cols="33" placeholder="Message" v-model="Message"></textarea>
                </div>
            </div>
...
<script setup>
    ...
    import { MakeDecision } from '~/services/npcforge'
    ...
    const RunHttp = async () => {
        try {
            ...
            res.value = await MakeDecision(AuthorizationToken.value, Checksum.value, Message.value)
        } catch (e) {
            console.error(e)
        } finally {
