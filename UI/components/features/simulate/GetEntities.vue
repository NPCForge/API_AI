<template>
    <div style="height: 100%; width: 100%;">
        <h3>Simulation route "Get Entities"</h3>
        <div class="hb"></div>
        <div class="d-flex justify-content-center align-items-start rounded"
            ...
            <div style="width: 100%; padding: 1%;" class="d-flex justify-content-start align-items-start">
                <div class="d-flex flex-column justify-content-start align-items-start">
                    ...
                    <input type="text" placeholder="Action" disabled value="GetEntities" name="Action">
...
<script setup>
    ...
    import { GetEntities } from '~/services/npcforge'
    ...
    const RunHttp = async () => {
        try {
            ...
            res.value = await GetEntities(AuthorizationToken.value)
        } catch (e) {
            console.error(e)
        } finally {
